...
if (file_exists('con-test.php')) {
    ...
    die("You need to create con-test.php to test the Persistence library." . PHP_EOL);
}
...
function testConstructor ($MYSQL_CONNECTION_URL) {
    ...
    $obj = new Persistence($MYSQL_CONNECTION_URL);
...
function testSQL($MYSQL_CONNECTION_URL) {
    ...
    //$assert->ok($r, "delete all the rows in test_persitence.");
