<?php
/**
 * persistence.php - an evolving code base for sustainable software working with
 * databases persisting web content.
 */
error_reporting(E_ALL | E_STRICT);
@date_default_timezone_set(date_default_timezone_get());

/**
 * Persistence - is the root, swiss army knife, object for working with MySQL DB.
 * Could be extended to support other types of DB by adding a new execute method.
 */
class Persistence {
    /**
     * __construct: Constructor for Persist objects.
